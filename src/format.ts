// Presentation-only formatting helpers. No business logic lives here — every
// figure is already computed by src/core. These just render it for a locale.
...
// Compact currency (USD) — e.g. $1.2M — for KPI tiles and budget rows.
...
// ROI is a multiple (pipeline / spend), not a percentage.
export function fmtMultiple(v: number, lang: Lang): string {
