...
// and narrates the deterministic ABM metrics the client computed. It must NOT
// recompute or invent figures; it only writes the territory briefing around the
// numbers it receives.
//
...
// repair it rather than discarding a usable briefing.
